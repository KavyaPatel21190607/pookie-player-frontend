# 🎀 Frontend - Periodic Lyrics Player# 🎀 Periodic Lyrics Player - Frontend# 🎀 Periodic Lyrics Player - Frontend
...
- **Periodic Lyric Display** - Visualizes lyrics as periodic elements- [Prerequisites](#prerequisites)## 📑 Table of Contents
...
## 🛠️ Built With- [Authentication Flow](#authentication-flow)- [Project Structure](#-project-structure)
...
**Frontend of Pookie's special music player 🎀💖**- [Styling & Theming](#-styling--theming)


### Key Highlights:- [Performance Optimizations](#-performance-optimizations)

- 🎵 **Real-time synchronized lyrics** with audio playback- [Troubleshooting](#-troubleshooting)

- 🧪 **Periodic table-inspired UI** for lyrics display- [Contributing](#-contributing)
...
- 🎨 **Beautiful gradient animations** and smooth transitions## 🌟 Overview

- 🎀 **Custom profile photos** with base64 storage
...
## Features- 🎵 **Real-time synchronized lyrics** with audio playback

- 🧪 **Periodic table-inspired UI** for lyrics display

### 🎼 Music Player- 💖 **Favorites system** with persistent storage

- **Play/Pause** functionality with smooth audio controls- 🔐 **Secure authentication** with JWT tokens

- **Previous/Next** track navigation- 📱 **Fully responsive design** for mobile and desktop

- **Seek controls** with visual progress bar- 🎨 **Beautiful gradient animations** and smooth transitions

- **Real-time duration** and current time display- 🎀 **Custom profile photos** with base64 storage
...
- **Periodic table elements** styling for each word### 🎼 Music Player
...
### 👤 User Features- **HTML5 Audio** with crossOrigin support

- **User registration** with email/password

- **Secure login** with JWT authentication### 📖 Lyrics Display
...
- **Default emoji avatar** (🎀)- **Animated transitions** between lyric lines

- **Logout** with token cleanup- **Element details** (symbol, name, atomic number)

- **Fallback text display** for non-element words

### ❤️ Favorites System- **Auto-scroll** to current lyric line

- **Add/Remove** songs to favorites

- **Visual feedback** (pink filled hearts)### 👤 User Features
...
### 📚 Library Management- **Logout** with token cleanup

- **Song browsing** with beautiful card layouts

- **Search functionality** by title or artist### ❤️ Favorites System
...
### 🎨 UI/UX- **Quick toggle** from Library, Home, and Favorites pages

- **Beautiful gradients** (pink, purple, blue theme)- **Toast notifications** for all actions

- **Smooth animations** with Framer Motion

- **Glass-morphism effects** with backdrop blur### 📚 Library Management
...
- **[Lucide React](https://lucide.dev/)** `^0.468.0` - Icon library## 🛠 Tech Stack
...
├── public/                      # Static assets  - `@radix-ui/react-toast` `^1.2.4`

├── src/

│   ├── components/             # Reusable components### State & Data Management

│   │   ├── ui/                # Shadcn UI components- **[Axios](https://axios-http.com/)** `^1.7.9` - HTTP client

│   │   ├── CompactSongList.tsx      # Song list with favorites- **localStorage** - Client-side storage for auth tokens

│   │   ├── MusicPlayer.tsx          # Audio player controls

│   │   ├── Navigation.tsx           # App navigation### Utilities

│   │   ├── PeriodicLyricDisplay.tsx # Periodic table lyrics- **[Sonner](https://sonner.emilkowal.ski/)** `^1.7.1` - Toast notifications

│   │   └── PeriodicTile.tsx         # Individual element tile- **[clsx](https://github.com/lukeed/clsx)** `^2.1.1` - Conditional classes

│   │- **[tailwind-merge](https://github.com/dcastil/tailwind-merge)** `^2.5.5` - Merge Tailwind classes

│   ├── pages/                  # Page components- **[class-variance-authority](https://cva.style/docs)** `^0.7.1` - Component variants

│   │   ├── Home.tsx           # Home page with lyrics display

│   │   ├── Library.tsx        # Song library with search### Development Tools

│   │   ├── Favorites.tsx      # User's favorite songs- **[ESLint](https://eslint.org/)** `^9.15.0` - Code linting

│   │   ├── Profile.tsx        # User profile & settings- **[TypeScript ESLint](https://typescript-eslint.io/)** `^8.15.0` - TS linting

│   │   ├── Login.tsx          # Login page- **[@vitejs/plugin-react](https://github.com/vitejs/vite-plugin-react)** `^4.3.4` - React support
...
│   │   ├── api.ts            # Axios instance & interceptors## 📁 Project Structure

│   │   ├── authService.ts    # Authentication API calls

│   │   ├── songService.ts    # Song-related API calls```

│   │   └── userService.ts    # User & favorites API callsfrontend/

│   │├── public/                      # Static assets

│   ├── types/                 # TypeScript type definitions├── src/

│   │   └── song.ts           # Song, LyricLine, ParsedToken types│   ├── components/             # Reusable components

│   ││   │   ├── ui/                # Shadcn UI components

│   ├── data/                  # Static data│   │   │   ├── accordion.tsx

│   │   └── periodicElements.ts # Periodic table element data│   │   │   ├── alert-dialog.tsx

│   ││   │   │   ├── alert.tsx

│   ├── styles/                # Global styles│   │   │   ├── avatar.tsx

│   │   └── globals.css       # Tailwind imports & custom CSS│   │   │   ├── badge.tsx

│   ││   │   │   ├── button.tsx

│   ├── App.tsx               # Main app component│   │   │   ├── card.tsx

│   ├── main.tsx              # React entry point│   │   │   ├── dialog.tsx

│   └── index.css             # Base styles│   │   │   ├── dropdown-menu.tsx

││   │   │   ├── input.tsx

├── index.html                 # HTML entry point│   │   │   ├── label.tsx

├── package.json              # Dependencies & scripts│   │   │   ├── progress.tsx

├── tsconfig.json             # TypeScript configuration│   │   │   ├── scroll-area.tsx

├── vite.config.ts            # Vite configuration│   │   │   ├── separator.tsx

└── README.md                 # This file│   │   │   ├── slider.tsx

```│   │   │   ├── toast.tsx

│   │   │   └── toaster.tsx

---│   │   ├── CompactSongList.tsx      # Song list with favorites

│   │   ├── MusicPlayer.tsx          # Audio player controls

## Prerequisites│   │   ├── Navigation.tsx           # App navigation

│   │   ├── PeriodicLyricDisplay.tsx # Periodic table lyrics

Before you begin, ensure you have the following installed:│   │   └── PeriodicTile.tsx         # Individual element tile

│   │

- **[Node.js](https://nodejs.org/)** `>=18.0.0` (LTS recommended)│   ├── pages/                  # Page components

- **[npm](https://www.npmjs.com/)** `>=9.0.0` or **[yarn](https://yarnpkg.com/)** `>=1.22.0`│   │   ├── Home.tsx           # Home page with lyrics display

- **[Git](https://git-scm.com/)** (for version control)│   │   ├── Library.tsx        # Song library with search

- A modern web browser (Chrome, Firefox, Safari, Edge)│   │   ├── Favorites.tsx      # User's favorite songs

- A code editor ([VS Code](https://code.visualstudio.com/) recommended)│   │   ├── Profile.tsx        # User profile & settings

│   │   ├── Login.tsx          # Login page

### System Requirements│   │   └── Register.tsx       # Registration page

- **OS**: Windows 10/11, macOS 10.15+, or Linux│   │

- **RAM**: Minimum 4GB (8GB+ recommended)│   ├── services/              # API service layer

- **Storage**: At least 500MB free space│   │   ├── api.ts            # Axios instance & interceptors

│   │   ├── authService.ts    # Authentication API calls

---│   │   ├── songService.ts    # Song-related API calls

│   │   └── userService.ts    # User & favorites API calls

## Installation│   │

│   ├── types/                 # TypeScript type definitions

### Step 1: Clone the Repository│   │   └── song.ts           # Song, LyricLine, ParsedToken types

│   │

```bash│   ├── data/                  # Static data

# Clone the main repository│   │   └── periodicElements.ts # Periodic table element data

git clone <repository-url>│   │

│   ├── styles/                # Global styles

# Navigate to the frontend directory│   │   └── globals.css       # Tailwind imports & custom CSS
...
### Step 2: Install Dependencies│   ├── index.css             # Base styles

│   └── vite-env.d.ts         # Vite type declarations

Using npm:│

```bash├── index.html                 # HTML entry point

npm install├── package.json              # Dependencies & scripts

```├── tsconfig.json             # TypeScript configuration

├── vite.config.ts            # Vite configuration

Using yarn:├── tailwind.config.js        # Tailwind CSS configuration

```bash├── postcss.config.js         # PostCSS configuration

yarn install├── eslint.config.js          # ESLint configuration
...
# Navigate to frontend directory## 🚀 Installation
...
- ⚠️ All Vite environment variables **must** start with `VITE_`This will install all dependencies listed in `package.json`.

- 🔒 Never commit `.env` file to version control

- 📝 Add `.env` to your `.gitignore` file### Step 3: Verify Installation
...
- 🐛 **Source maps** - Easy debugging# Create .env file (Linux/macOS)

- 📊 **Error overlay** - Visual error messagestouch .env
...
```bash- ⚠️ All Vite environment variables **must** start with `VITE_`

npm run build- 🔒 Never commit `.env` file to version control
...
3. **Minify** JavaScript and CSS## 🏃‍♂️ Running the Application
...
│   ├── index-[hash].js  # Bundled JavaScriptThe application will be available at:

│   ├── index-[hash].css # Bundled CSS- **Local**: `http://localhost:5173`

│   └── [other assets]   # Images, fonts, etc.- **Network**: `http://<your-ip>:5173`
...
### Deploy the Build- 🐛 **Source maps** - Easy debugging

- 📊 **Error overlay** - Visual error messages

You can deploy the `dist/` folder to any static hosting service:- 🔍 **React DevTools** compatible
...
**State Management**:## 🏗 Building for Production
...
#### 2. MusicPlayer.tsx - Audio Player├── assets/

**Purpose**: Controls audio playback and displays player UI│   ├── index-[hash].js  # Bundled JavaScript

│   ├── index-[hash].css # Bundled CSS

**Features**:│   └── [other assets]   # Images, fonts, etc.

- HTML5 Audio element└── [other files]
...
---
  ...
  login: async (email, password) => {
    ...
    const response = await api.post('/auth/login', {## 🔌 API Integration
...
// Mobile-first approach## 📝 Lyrics Display
...
**Built with love for Pookie 🎀💖**className="hidden lg:block"           // Desktop only
